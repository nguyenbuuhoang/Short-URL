            ...
            <div id="filter-columns" style="display: none;" class="mt-3">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" id="nameFilter" class="form-control" placeholder="Search link">
                    </div>
                    <div class="col-md-3 mb-2">
                        ...
                        <select id="sortBy" class="form-control">
                            ...
                            <option value="expired_at">Expired At</option>
        ...
        $(document).ready(function() {
            ...
            function createShortURLRow(shortUrl) {
                ...
                if (now > expiredAtDate) {
                    const expiredCell = $('<td>').text('Expired');
